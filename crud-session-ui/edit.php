...
if (isset($_GET['edit'])) {
  $id = $_GET['edit'];
  $update = true;
  $record = mysqli_query($conn, "SELECT * FROM booking WHERE id=$id");

if (count(array($record)) > 0) {
  $rowedit = mysqli_fetch_array($record);

  $id = $rowedit["id"];
  $resi_number = $rowedit["resi_number"];
  $product_id = $rowedit["product_id"];
  $user_id = $rowedit["user_id"];
  $status = $rowedit["status"];
  $current_location = $rowedit["current_location"];
...
<head>
    ...
    <link rel="stylesheet" href="../target-free-admin-template/assets/materialize/css/materialize.min.css"
    ...
    <div id="wrapper">
        <nav class="navbar navbar-default top-navbar" role="navigation">
            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li><a class="dropdown-button waves-effect waves-dark" href="logout.php" data-activates="dropdown4"><i
                            class="fa fa-envelope fa-fw"></i> <i class="material-icons right">arrow_drop_down</i>Logout</a>
                </li>
                ...
                <li><a class="dropdown-button waves-effect waves-dark" href="#!" data-activates="dropdown1"><i
                            class="fa fa-user fa-fw"></i> <b><?php echo $_SESSION['username']; ?></b> <i
                ...
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li>
                                get <a href="#">Second Level Link</a>
                            </li>
                            <li>
                          ...
                          <input type="hidden" name="id" id="" value="<?php echo $row["id"]; ?>">
                         	<div class="col s12">
								  <div class="row">
									<div class="input-field col s6">
									  <input id="icon_prefix" type="text" value="<?php echo $rowedit['resi_number'] ?>" name="resi_number" class="validate">
                                      <!-- <label for="icon_prefix">RESI Number</label> -->
									</div>
									<div class="input-field col s6">
									  <input id="icon_telephone" type="tel" value="<?php echo $rowedit['product_id'] ?>" name="product_id" class="validate">
								...
								<div class="col s12">
								  <div class="row">
									<div class="input-field col s6">
									  <input id="user_id" type="text" value="<?php echo $rowedit['user_id'] ?>"  name="user_id" class="validate">
									  <!-- <label for="email" data-error="wrong" data-success="right">User ID</label> -->
                                    </div>
                                    <div class="input-field col s6">
                                        <input id="status" type="text" value="<?php echo $rowedit['status'] ?>"  name="status" class="validate">
                            ...
                            <div class="col s12">
							  <div class="row">
                                ...
                                <input id="status" type="text" value="<?php echo $rowedit['current_location'] ?>"  name="current_location" class="validate">
                            ...
                            <div class="col s12">
							  <div class="row">
								<div class="input-field col s12">
                               <button type="submit"  name="update" class="waves-effect waves-light btn btn-block">Submit</button>
								</div>
							  </div>
                            </div> 
