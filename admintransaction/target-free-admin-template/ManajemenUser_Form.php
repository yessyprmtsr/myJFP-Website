    ...
    <form class="col s12" action="ManajemenUser_Output.php" method="post">
      ...
      <div class="row">
        <div class="input-field col s12">
          <input value="I am not editable" id="phone" type="number" class="validate" name="phone">
      ...
      <div class="row">
        <div class="col s12">
          <div class="input-field inline">
            <input class="form-check-input" type="radio" id="inlineRadio1" value="Customer" name="type">
            <label class="form-check-label" for="inlineRadio1">Customer</label>
            <input class="form-check-input" type="radio" id="inlineRadio2" value="Admin" name="type">
