                                        ...
                                        <div class="col-lg-6 col-sm-12 col-md-">
                                            <form action="output.php" method="post">
                                                <div class="form-group text-center">
                                                    <label for="">RESI Number</label>
                                                    <input type="text col-sm-12" placeholder="enter resi umber"
                                                        name="resi_number">
                                                </div>
                                                <div class="form-group text-center">
                                                    <label for="">Product ID</label>
                                                    <input type="text col-sm-12" placeholder="enter product id"
                                                        name="product_id">
                                                </div>
                                                <div class="form-group text-center">
                                                    <label for="">User ID</label>
                                                    <input type="text col-sm-12" placeholder="enter user id"
                                                        name="user_id">
                                                </div>
                                                <div class="form-group text-center">
                                                    <label for="">Status Pengiriman </label>
                                                    <input type="text col-sm-12" placeholder="enter status"
                                                        name="status">
                                                </div>
                                                <div class="form-group text-center">
                                                    <label for="">Current Sending Location </label>
                                                    <input type="text col-sm-12" placeholder="enter location"
                                                        name="current_location">
                                                </div>
                                                <div style="text-align: center;">
                                                    <input type="submit" class="btn btn-primary mb-2" value="Generate">
                                                </div>
                                            </form>
                                        </div>
                                    </div>
